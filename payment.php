...
<body>
<div class="jumbotron" style="background: url('images/pay.jpg') no-repeat;background-size: cover;height: 500px;"></div>	
...
<input type="submit" class="btn btn-primary" style="background-color:#ff9;color:black;" name="pay_submit" value="PAY">
     </div>
    </div>
    </div>
